...
const (
	...
	CONTROLLER_BUTTON_MISC1         GameControllerButton = C.SDL_CONTROLLER_BUTTON_MISC1
	CONTROLLER_BUTTON_PADDLE1       GameControllerButton = C.SDL_CONTROLLER_BUTTON_PADDLE1
	CONTROLLER_BUTTON_PADDLE2       GameControllerButton = C.SDL_CONTROLLER_BUTTON_PADDLE2
...
func GameControllerMappingForIndex(index int) string {
	...
	defer C.SDL_free(unsafe.Pointer(mappingString))
